...
version_url = "http://bemaniwiki.com/index.php?beatmania+IIDX+30+RESIDENT"
main_page = urlopen(version_url)
print(main_page)
version_name = BeautifulSoup(main_page, "html5lib").findAll('strong', text=re.compile("^LDJ:x:y:A:"))[0].text[-10:]
print(version_name)

new_url = "http://bemaniwiki.com/index.php?beatmania+IIDX+30+RESIDENT/%BF%B7%B6%CA%A5%EA%A5%B9%A5%C8"
old_url = "http://bemaniwiki.com/index.php?beatmania+IIDX+30+RESIDENT/%B5%EC%B6%CA%A5%EA%A5%B9%A5%C8"
